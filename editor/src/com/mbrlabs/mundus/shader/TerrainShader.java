...
public class TerrainShader extends BaseShader {
    ...
    private static final String VERTEX_SHADER = "shader/terrain/terrain.vert.glsl";
    private static final String FRAGMENT_SHADER = "shader/terrain/terrain.frag.glsl";
