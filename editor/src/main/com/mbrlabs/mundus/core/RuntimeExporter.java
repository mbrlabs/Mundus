...
// Scene scene =
/// DescriptorConverter.convert(kryoManager.loadScene(projectContext, name),
...
// destFolder.mkdirs();
// }
// FileHandle jsonOutput =
/// Gdx.files.absolute(FilenameUtils.concat(destFolder.path(), "mundus"));
...
//
// // copy assets
// FileHandle assetOutput =
/// Gdx.files.absolute(FilenameUtils.concat(destFolder.path(), "assets"));
// Gdx.files.absolute(FilenameUtils.concat(projectContext.path,
/// "assets")).copyTo(assetOutput);
// }
//
...
// if(tex.getSplatmap() != null)
/// dto.setSplatmapPath(tex.getSplatmap().getPath());
// // Base
