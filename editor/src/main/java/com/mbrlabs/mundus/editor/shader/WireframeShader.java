...
public class WireframeShader extends BaseShader {
    ...
    private static final String VERTEX_SHADER = "com/mbrlabs/mundus/editor/shader/wire.vert.glsl";
    private static final String FRAGMENT_SHADER = "com/mbrlabs/mundus/editor/shader/wire.frag.glsl";
