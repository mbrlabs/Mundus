...
public abstract class GLFWIconSetter {
    /**
     * Sets icon for application. Icon file must be square, typically 128x128.
     * Larger files may not be supported by all operating systems.
     * 
     * @throws IllegalStateException
     *             when error occurred during icon setting.
     */
    public abstract void setIcon(FileHandle iconCacheFolder, FileHandle icoFile, FileHandle pngFile)
            throws IllegalStateException;

    /**
     * @return new instance of {@link GLFWIconSetter} implementation for current
     *         platform or {@link DefaultGLFWIconSetter} when no other
    ...
    private static class WinGLFWIconSetter extends GLFWIconSetter {
        ...
        public void setIcon(FileHandle iconCacheFolder, FileHandle icoFile, FileHandle pngFile) {
            ...
            try {
                ...
                User32.INSTANCE.SendMessageW(User32.INSTANCE.GetActiveWindow(), User32.WM_SETICON,
                        new WPARAM(User32.BIG_ICON), hImage);
            } catch (Exception e) {
