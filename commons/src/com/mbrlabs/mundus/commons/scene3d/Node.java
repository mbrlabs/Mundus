 ...
 * Each child node defines position, rotation & scale relative to it's parent.
 *
...
public interface Node<T extends Node> {
     ...
     *
     * The matrix is computed by multiplying the transformation matrix of all children
     * with this node.
     *
     * This looks like this:
     * node0 * node1 * node2 * .. * thisNode = transformation matrix of this node in world space
     *
